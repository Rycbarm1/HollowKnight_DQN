...
class Model:
    ...
    def load_model(self):
        ...
        if os.path.exists("./model/act_part.h5"):
            Debug("load action model", debug_level=DEBUG_LEVEL.NORMAL)
        ...
        if os.path.exists("./model/move_part.h5"):
            Debug("load move model", debug_level=DEBUG_LEVEL.NORMAL)
    ...
    def save_mode(self):
        Debug("save model", debug_level=DEBUG_LEVEL.NORMAL)
